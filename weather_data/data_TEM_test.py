...
def get_split_time(num_domain=2, mode='pre_process', data_file=None, station=None, dis_type='mmd'):
    spilt_time = {
        '2': [('2019-1-1 0:0', '2019-4-30 23:0'), ('2019-5-2 0:0', '2019-7-30 23:0')]
    }
    if mode == 'pre_process':
...
def load_weather_data_multi_domain(file_path, batch_size=6, station='Jintang', number_domain=2, mode='pre_process',
    ...
    feat_v, ytrue_v = data_QX.create_dataset(
        data_file, station=station, start_date='2019-9-2 0:0', end_date='2019-12-31 23:0', mean=None, std=None)
...
if __name__ == '__main__':
    file_path = r'/Volumes/王九和/科研/农业大数据相关/实验/实验程序/玉皇/AdaRNN-BIT/玉皇/weather_data'
